                  ...
                  <div className="tp-ab-main-img p-relative">
                    ...
                    <div className="about__exprience tp-ab-counter">
                      <h3 className="counter">
                        <Count add_style={true} number={36} />
                      </h3>
                      <i>
                        Years of <br />
                        Excellence
              ...
              >
                <div className="tp-section">
                  <h3 className="tp-section__title ab-title mb-25">
                    Trusted Partner in Industrial & Specialty Chemicals
                  </h3>
                  ...
                  <p className="mr-20 mb-40">
                    At Divya Chemical Industry, we are dedicated to delivering
                    premium-quality industrial and specialty chemicals for a
                    wide range of sectors including textiles, pharmaceuticals,
                    agriculture, and more. Our commitment to innovation,
                    sustainability, and customer satisfaction drives everything
                    we do.
                  </p>
                </div>
                ...
                <div className="tp-about__info-list ab-check-list mb-55">
                  <ul>
                    <li>
                      <i className="fa-solid fa-check"></i>ISO Certified Manufacturing
                    </li>
                    <li>
                      <i className="fa-solid fa-check"></i>Custom Chemical Solutions
                    </li>
                    <li>
                      <i className="fa-solid fa-check"></i>Safe & Sustainable Practices
                    </li>
                    <li>
                      <i className="fa-solid fa-check"></i>Pan-India Distribution
                    </li>
                  </ul>
                </div>
