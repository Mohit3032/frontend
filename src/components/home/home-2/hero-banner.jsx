...
const content = {
  ...
  title: (
    <>
      ...
      Trusted Chemical Supply
    </>
  ),
  des: (
    <>
      At Divya Chemical Industry, we deliver high-quality chemicals for manufacturing, <br />
      pharmaceuticals, research, and industrial applications — with a commitment to safety and reliability.
    </>
  ),
...
const hero_box = [
  ...
  },
  {
    ...
    des: "High-Purity Certified Chemicals",
    color: "green-icon",
    border: "green-border",
  },
];
